...
|--------------------------------|--------------------------------|----------------------------------------------------------------------------------------------------------|---------------|
| family_name                    | family_name                    | ``tstr``                                                                                                 | TODO          |
| given_name                     | given_name                     | ``tstr``                                                                                                 | TODO          |
| birth_date                     | birth_date                     | ``full-date``, see [Section 3.1.4](#314-attribute-birth_date).                                           | TODO          |
| birth_place                    | place_of_birth                 | ``place_of_birth``, see [Section 3.1.5](#315-attribute-place_of_birth).                                  | TODO          |
| nationality                    | nationality                    | ``nationalities``, see [Section 3.1.2](#312-attribute-nationality).                                      | TODO          |
| resident_address               | resident_address               | ``tstr``                                                                                                 | TODO          |
| resident_country               | resident_country               | ``tstr``                                                                                                 | TODO          |
| resident_state                 | resident_state                 | ``tstr``                                                                                                 | TODO          |
| resident_city                  | resident_city                  | ``tstr``                                                                                                 | TODO          |
| resident_postal_code           | resident_postal_code           | ``tstr``                                                                                                 | TODO          |
| resident_street                | resident_street                | ``tstr``                                                                                                 | TODO          |
| resident_house_number          | resident_house_number          | ``tstr``                                                                                                 | TODO          |
| personal_administrative_number | personal_administrative_number | ``tstr``                                                                                                 | TODO          |
| portrait                       | portrait                       | ``bstr``; see additional information in [Section 2.3](#23-optional-attributes-specified-in-cir-20242977) | TODO          |
| family_name_birth              | family_name_birth              | ``tstr``                                                                                                 | TODO          |
| given_name_birth               | given_name_birth               | ``tstr``                                                                                                 | TODO          |
| sex                            | sex                            | ``uint``; see additional information in [Section 2.3](#23-optional-attributes-specified-in-cir-20242977) | TODO          |
| email_address                  | email_address                  | ``tstr``                                                                                                 | TODO          |
| mobile_phone_number            | mobile_phone_number            | ``tstr``                                                                                                 | TODO          |
| expiry_date                    | expiry_date                    | ``tdate`` or ``full-date``                                                                               | TODO          |
| issuing_authority              | issuing_authority              | ``tstr``                                                                                                 | TODO          |
| issuing_country                | issuing_country                | ``tstr``                                                                                                 | TODO          |
| document_number                | document_number                | ``tstr``                                                                                                 | TODO          |
| issuing_jurisdiction           | issuing_jurisdiction           | ``tstr``                                                                                                 | TODO          |
| location_status                | -                              | See [Section 3.1.3](#313-attribute-location_status).                                                     | TODO          |
| issuance_date                  | issuance_date                  | ``tdate`` or ``full-date``                                                                               | TODO          |
| trust_anchor                   | trust_anchor                   | ``tstr``                                                                                                 | TODO          |
...
| portrait              | picture                  | string; data URL containing the base64-encoded portrait in JPEG format according to PID_03 in [Annex 2, Topic 3](https://eu-digital-identity-wallet.github.io/eudi-doc-architecture-and-reference-framework/latest/annexes/annex-2/annex-2-high-level-requirements/) | Section 5.1 of [OIDC]                                                                                                              |
